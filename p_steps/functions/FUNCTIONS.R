...
RUN_LOG <-  function(output.loc){
  ...
  if(exists("start_study_date")) logr::log_print(c('Start Study Period:',start_study_date))
  if(exists("end_study_date")) logr::log_print(c('End Study Period:',end_study_date))
