...
output_folders<-list(output_hist_preg, output_cov_neg_pan_preg, output_cov_pos_pan_preg)
...
maternal_death_cov<-as.data.frame(cbind(maternal_death_id, maternal_death_date))
