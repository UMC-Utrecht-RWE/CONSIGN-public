...
fwrite(table_1a, paste0(final_output_suppl,DAP, "_ATC_",(j+2),"_table_1_a.csv"))
...
colnames(table_1b)<-c("Drug", "trim 1, -30 days", "trim 1, +30 days", "trim 2, -30 days", 
                      "trim 2, +30 days","trim 3, -30 days", "trim 3, +30 days")
fwrite(table_1b, paste0(final_output_suppl, DAP,"_ATC_",(j+2), "_table_1_b.csv"))
...
colnames(table_1c)<-c("Drug", "trim 1, -30 days", "trim 1, +30 days", "trim 2, -30 days", 
                      "trim 2, +30 days","trim 3, -30 days", "trim 3, +30 days")
fwrite(table_1c, paste0(final_output_suppl, DAP,"_ATC_",(j+2),"_table_1_c.csv"))
