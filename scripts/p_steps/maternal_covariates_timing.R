...
cohort_covariate_folders<-c(output_mat_cov_pan_neg, output_mat_cov_pan_pos,  output_mat_cov_covid_pos_match)
...
output_folders<-c(g_output_mat_cov_pan_neg, g_output_mat_cov_pan_pos, g_output_mat_covariate_covid_pos_match)
cohort_names<-c("covid_negative_pregnant_control.csv", "cases.csv", "covid_positive_control.csv")
