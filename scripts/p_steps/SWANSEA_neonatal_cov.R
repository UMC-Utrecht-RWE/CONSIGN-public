...
# low apgar
  ...
  APGARLOW_SO_ID<-SURV_OB$person_id[((SURV_OB$so_source_column=="BIRTH_APGAR_SCORE")&(SURV_OB$so_source_value%in%c(0,1,2,3)))]
  APGARLOW_SO_Date<-SURV_OB$so_date[((SURV_OB$so_source_column=="BIRTH_APGAR_SCORE")&(SURV_OB$so_source_value%in%c(0,1,2,3)))]
