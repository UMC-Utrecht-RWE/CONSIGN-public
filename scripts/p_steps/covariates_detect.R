...
colnames(cardio_cov)<-c("person_id","date")
...
colnames(cancer_cov)<-c("person_id","date")
...
colnames(resp_cov)<-c("person_id","date")
...
colnames(liver_cov)<-c("person_id","date")
...
colnames(HIV_cov)<-c("person_id","date")
...
colnames(kidney_cov)<-c("person_id","date")
...
colnames(diabetes_cov)<-c("person_id","date")
...
colnames(obesity_cov)<-c("person_id","date")
...
colnames(sickle_cov)<-c("person_id","date")
...
colnames(immunosupress_cov)<-c("person_id","date")
...
colnames(mental_cov)<-c("person_id","date")
