...
fwrite(cancer_cov, paste0(output_cov,"cancer.csv"))
...
fwrite(resp_cov, paste0(output_cov,"respiratory.csv"))
...
fwrite(liver_cov, paste0(output_cov,"liveriratory.csv"))
#################################################################################
# HIV
...
fwrite(HIV_cov, paste0(output_cov,"HIV.csv"))
...
fwrite(kidney_cov, paste0(output_cov,"kidney.csv"))
...
fwrite(diabetes_cov, paste0(output_cov,"diabetes.csv"))
...
fwrite(obesity_cov, paste0(output_cov,"obesity.csv"))
...
fwrite(sickle_cov, paste0(output_cov,"sickle.csv"))
