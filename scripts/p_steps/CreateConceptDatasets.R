...
CreateConceptDatasets <- function(codesheet=covid_codelist,file=events_tables, c.voc="coding_system", c.concept="event_abbreviation", c.codes="code", c.startwith = c("ICD9CM", "ICD9"),
