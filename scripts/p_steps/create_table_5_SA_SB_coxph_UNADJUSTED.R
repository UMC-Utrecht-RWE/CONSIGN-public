...
all_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=model_data))
...
T1_all_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t1_model_data))
...
T2_all_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t2_model_data))
...
# T3_all_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t3_model_data))
...
T1_severe_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t1_model_data_severe))
...
T2_severe_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t2_model_data_severe))
...
# T3_severe_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t3_model_data_severe))
...
T1_nonsevere_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t1_model_data_nonsevere))
...
T2_nonsevere_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t2_model_data_nonsevere))
...
# T3_nonsevere_case_cox<-summary(coxph(Surv(duration, SA) ~ cohort , data=t3_model_data_nonsevere))
...
fwrite(SA_output, paste0(final_output_dir, "table_5_Spont_Abort_unadjusted.csv"))
...
all_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=model_data))
...
t1_model_data<-(model_data[model_data$cov_trimester==1,])
T1_all_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t1_model_data))
T1_all_confint<-round(T1_all_case_cox$conf.int, 2)
all_cox_SB_results[[1]]<-paste0(T1_all_confint[1,1], " (", T1_all_confint[1,3], "-", T1_all_confint[1,4], ")")

t2_model_data<-(model_data[model_data$cov_trimester==2,])
T2_all_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t2_model_data))
T2_all_confint<-round(T2_all_case_cox$conf.int, 2)
all_cox_SB_results[[2]]<-paste0(T2_all_confint[1,1], " (", T2_all_confint[1,3], "-", T2_all_confint[1,4], ")")


t3_model_data<-(model_data[model_data$cov_trimester==3,])
T3_all_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t3_model_data))
T3_all_confint<-round(T3_all_case_cox$conf.int, 2)
...
t1_model_data_severe<-(model_data_severe[model_data_severe$cov_trimester==1,])
T1_severe_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t1_model_data_severe))
T1_severe_confint<-round(T1_severe_case_cox$conf.int, 2)
severe_cox_SB_results[[1]]<-paste0(T1_severe_confint[1,1], " (", T1_severe_confint[1,3], "-", T1_severe_confint[1,4], ")")


t2_model_data_severe<-(model_data_severe[model_data_severe$cov_trimester==2,])
T2_severe_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t2_model_data_severe))
T2_severe_confint<-round(T2_severe_case_cox$conf.int, 2)
severe_cox_SB_results[[2]]<-paste0(T2_severe_confint[1,1], " (", T2_severe_confint[1,3], "-", T2_severe_confint[1,4], ")")


t3_model_data_severe<-(model_data_severe[model_data_severe$cov_trimester==3,])
T3_severe_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t3_model_data_severe))
T3_severe_confint<-round(T3_severe_case_cox$conf.int, 2)
...
t1_model_data_nonsevere<-(model_data_nonsevere[model_data_nonsevere$cov_trimester==1,])
T1_nonsevere_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t1_model_data_nonsevere))
T1_nonsevere_confint<-round(T1_nonsevere_case_cox$conf.int, 2)
nonsevere_cox_SB_results[[1]]<-paste0(T1_nonsevere_confint[1,1], " (", T1_nonsevere_confint[1,3], "-", T1_nonsevere_confint[1,4], ")")


t2_model_data_nonsevere<-(model_data_nonsevere[model_data_nonsevere$cov_trimester==2,])
T2_nonsevere_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t2_model_data_nonsevere))
T2_nonsevere_confint<-round(T2_nonsevere_case_cox$conf.int, 2)
nonsevere_cox_SB_results[[2]]<-paste0(T2_nonsevere_confint[1,1], " (", T2_nonsevere_confint[1,3], "-", T2_nonsevere_confint[1,4], ")")


t3_model_data_nonsevere<-(model_data_nonsevere[model_data_nonsevere$cov_trimester==3,])
T3_nonsevere_case_cox<-summary(coxph(Surv(duration, SB) ~ cohort , data=t3_model_data_nonsevere))
T3_nonsevere_confint<-round(T3_nonsevere_case_cox$conf.int, 2)
...
fwrite(SB_output, paste0(final_output_dir, "table_5_Still_Birth_unadjusted.csv"))
