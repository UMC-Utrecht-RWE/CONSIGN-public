...
names_drug_groups<-list("Diabetes", "Antithrombotic","Antihypertensives", "Corticoisteroids",
                        "Antibacterials", "Antimycotics","Antimycobacterials", "Antivirals", 
                        "Immune_sera_globulins", "Vaccinations", "Antineoplastic", "Immunostimulants", 
                        "Immunosuppressants", "Anti_inflammatory", "Antigout", "Analgesics",
                        "Psycholeptics", "Psychoanaleptics", "Antiprotozoals",
                        "Antihelminthics", "Nasal", "Obstructive_airway", "Cough_cold")

ATC_groups<-list("A10", "B01" ,c( "C02", "C03", "C04", "C07", "C08", "C09"),"H02", "J01", "J02",
                  "J04" , "J05" , "J06", "J07" ,  "L01", "L03", "L04", "M01" ,  "M04", "N02",
                 "N05", "N06" , "P01", "P02",  "R01" ,  "R03",  "R05" )
...
ATC_detect<-function(my_data= my_dt_MED, names=names_drug_groups, ATC=ATC_groups){
  ...
  fwrite(my_df, paste0(raw_atc_counts, names[i],".csv"))
