...
merge(PERSONS, OBS_SPELLS, by="person_id")
...
PERSONS$comp_month_birth<-PERSONS$month_of_birth
PERSONS$comp_month_birth[is.na(PERSONS$month_of_birth)]<-6

DOB<-paste0(PERSONS$comp_day_birth, "/", PERSONS$comp_month_birth, "/",PERSONS$year_of_birth)
