...
#create summary of baseline characteristics NOT divided by trimester to aid in summarization
...
case_data_trim<-case_data
control_data_trim<-control_data
...
fwrite(baseline_table, paste0(final_output_dir,DAP,"_table3_pooled_trimesters", "_baseline.csv"))
